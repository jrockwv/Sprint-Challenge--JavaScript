...
tyrannosaurus.period = 'Late Cretaceous';
tyrannosaurus.rawr = 'RAWERSRARARWERSARARARRRR!';
...
*/
let populationTotal =
zooAnimals.reduce((acc, value) => acc += value.population, 0);
